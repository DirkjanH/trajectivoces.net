<?php
/**
  * @version   $Id: Gallery.php 10871 2013-05-30 04:06:26Z btowles $
...
class RokGalleryAdminAjaxModelGallery extends RokCommon_Ajax_AbstractModel
{
    ...
    public function get($params)
    {
        ...
        try
        {
            ...
            $html = RokCommon_Composite::get('rokgallery.galleryorder')->load('default.php', array('slices' => $sortable_slices));
