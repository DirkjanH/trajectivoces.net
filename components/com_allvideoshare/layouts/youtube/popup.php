...
<div id="avs-youtube-layout-popup-<?php echo $uid; ?>" class="avs avs-youtube avs-youtube-layout-popup" data-params='<?php echo json_encode( $jsonArray ); ?>'>
    <!-- Gallery -->
    <div class="avs-videos avs-row mb-4">
        <?php foreach ( $videos as $index => $video ) :
            ...
            ?>
            <div class="<?php echo implode( ' ', $classNames ); ?>" data-id="<?php echo $video->id; ?>" data-title="<?php echo $video->title; ?>" data-mfp-src="<?php echo AllVideoShareYouTubeHelper::getPlayerUrl( $video, $params ); ?>">
                <div class="mb-3 p-2">
