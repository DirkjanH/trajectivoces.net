...
$column_class = AllVideoShareHelper::getCSSClassNames( $this->params, 'grid.related' );
$popup_class  = AllVideoShareHelper::getCSSClassNames( $this->params, 'popup' );
?>

<?php if ( ! empty( $this->items ) ) : ?>
	<div class="avs-related avs-grid mb-4<?php echo $popup_class; ?>" data-player_ratio="<?php echo $player_ratio; ?>">
		<h4 class="mt-0 mb-3"><?php echo Text::_( 'COM_ALLVIDEOSHARE_TITLE_RELATED_VIDEOS' ); ?></h4>
