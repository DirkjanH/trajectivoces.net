...
Element.extend({
	...
	*/
	...
	Example:
		...
		<img src="../../Trajecti zingt Heinrich Schütz/scripts/whatever.gif" alt="whatever dude">
		(end)
	*/
	...
	add: function(fn){
		...
		if (document.readyState && window.webkit){
			...
			if (!$('ie_ready')){
				...
				document.write('<script id="ie_ready" defer src="../../Trajecti zingt Heinrich Schütz/scripts/' + src + '"><\/script>');
