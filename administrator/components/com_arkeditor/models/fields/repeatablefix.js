    ...
    $.JRepeatable = function(input, options){
        ...
        self.init = function(){
            ...
            $(document).on('click', self.options.btModalOpen, function (e) {
            	e.preventDefault();
            	if(self.$modalWindow[0].open)
                { 
                    self.$modalWindow[0].open();
                }
                else
                {
            ...
            self.$modalWindow.on('click', self.options.btModalClose, function (e) {
            	e.preventDefault();
            	if(self.$modalWindow[0].close) 
                {
                    self.$modalWindow[0].close();
                }
                else
                {
        ...
        self.prepareModal = function(){
            ...
            if(Joomla.initialiseModal)
            {
                Joomla.initialiseModal(modalEl[0],{show: false, backdrop: 'static'});
                self.$modalWindow = modalEl;
                modalEl[0].addEventListener('show.bs.modal', function() {
                    self.resizeModal();
            ...
            //bootstrapModal.modal({show: false, backdrop: 'static'});
        ...
        self.resizeModal = function (){
        	if(! Joomla.initialiseModal && !self.$modalWindow.is(':visible')){
