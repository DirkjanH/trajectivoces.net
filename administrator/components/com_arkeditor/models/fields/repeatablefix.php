...
class JFormFieldRepeatableFix extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		$str[] = '<button class="open-modal btn'.$buttonClass.'" id="' . $this->id . '_button" >' . $icon . $select . '</button>';
		...
		$file = dirname(__FILE__) . "/repeatablefix.js";
