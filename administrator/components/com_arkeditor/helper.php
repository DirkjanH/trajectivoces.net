...
class ARKHelper
{
	...
	public static function getActions()
	{
		...
		$actions = JAccess::getActionsFromFile(JPATH_ADMINISTRATOR . '/components/com_arkeditor/access.xml');
...
abstract class ARKModuleHelper extends JModuleHelper
{
	...
	protected static function &_load()
	{
		...
		if (!($clean = $cache->get($cacheid))) {
            ...
            {
				ARKHelper::error( JText::sprintf('JLIB_APPLICATION_ERROR_MODULE_LOAD', $ex->getMessage()) );
				return false;
			}
