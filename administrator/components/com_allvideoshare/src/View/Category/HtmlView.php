...
namespace MrVinoth\Component\AllVideoShare\Administrator\View\Category;
...
class HtmlView extends BaseHtmlView {
	...
	protected function addToolbar()	{
		...
		$title = $isNew ? Text::sprintf( 'COM_ALLVIDEOSHARE_CATEGORY_ADD_TITLE', $componentName ) : Text::sprintf( 'COM_ALLVIDEOSHARE_CATEGORY_EDIT_TITLE', $componentName );
		ToolbarHelper::title( $title, 'jcc fa-folder-open' );
